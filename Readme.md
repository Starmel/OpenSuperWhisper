...
- ⌨️ Multiple global recording triggers — up to four key combinations (e.g. ⌥Space, F13) plus up to four single keys (a modifier like Right ⌥ or Fn, or a regular key); single keys require Input Monitoring permission
